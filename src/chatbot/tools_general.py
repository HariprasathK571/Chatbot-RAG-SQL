...
class GeneralTool:
    ...
    ("system",
     ...
     "If the user greets (hi/hello/hey/good morning etc.), reply politely and introduce yourself like:\n"
     "\"Hi! I'm Datasage, created by Hariprasath Kumar. How can I help you today?\""),
    ("user", "{q}")
])
